...
inset.tibble <- tibble::tibble(
  x = c(0.98, 0.98), y = c(0.98, 0.0), 
  vp.width = c(0.4, 0.6), vp.height = c(0.5, 0.5),
...
ggplot2::ggplot() +
  ...
  ggplot2::theme(
    ...
    legend.background = element_rect(fill = "grey90", size = 0.1, linetype = "solid", colour = "black")
  )
```
