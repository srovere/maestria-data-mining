...
ggplot2::ggplot() +
  ...
  ggplot2::annotate(geom = "text", x = -40, y = -60, parse = TRUE,
  ...
  ggplot2::theme_bw() +
  ggplot2::theme(
    plot.title = ggplot2::element_text(vjust = -12, hjust = 0.2),
    plot.subtitle = ggplot2::element_text(vjust = -15, hjust = 0.22),
