...
Se destacan dos reglas dos reglas con alto grado de confianza durante todos los períodos. Son aquellas que indican (son sutiles diferencias) que el comercio con nivel de precio *muy caro* es *Jumbo* **independientemente** del período que se considere. Esto fue previamente descubierto en el trabajo anterior (ver mapa de calor de 4.2.2). También observamos reglas similares para productos *muy baratos* o de precio *medio* asociados a *Carrefour* y *Coto*. Esto también es consistente con lo encontrado en el trabajo anterior.
