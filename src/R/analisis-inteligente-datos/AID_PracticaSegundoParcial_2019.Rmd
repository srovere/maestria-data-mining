...
```{r, echo=FALSE, warnings=FALSE, message=FALSE }
modelo.qda <- MASS::qda(Class ~ ., data = cancer, CV = TRUE)
print("Matriz de contingencia")
table(modelo.qda$class, cancer$Class, dnn = c("Datos reales", "Datos predichos"))
sprintf("Clasifica correctamente el %.2f%% de los casos", 100 * mean(modelo.qda$class == cancer$Class))
```
