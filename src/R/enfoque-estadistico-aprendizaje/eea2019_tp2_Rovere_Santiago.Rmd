...
knitr::kable(
  ...
  col.names = c("Barrio", "Precio promedio del metro cuadrado", "Cantidad de propiedades")
)
```
...
ggplot2::ggplot(data = tidyr::unnest(resultados.modelos.tipo.propiedad, agmnt),
                mapping = ggplot2::aes(x = .fitted, y = .resid)) +
  ggplot2::geom_point(size = 0.2, col = 'tomato') +
  ggplot2::geom_hline(yintercept = 0) +
  ggplot2::geom_smooth(se = FALSE, col = 'darkslategray4') +
  ggplot2::facet_wrap(~property_type, ncol = 1)
```
