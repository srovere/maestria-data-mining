...
Se observa que el valor de $R^2$ ajustado para este modelo se ha incrementado levemente a un valor de 0.81, superando a todos los modelos anteriores. En relación a los coeficientes, todos son altamente significativos. El análisis de los mismos, los separaremos en dos partes. Primero se analizarán los coeficientes asociados a covariables transformadas utilizando el *logaritmo natural*. Luego, se analizarán los coeficientes asociados a variables no transformadas.

Para el primer caso, dado que tanto la variable de respuesta como las covariables han sido transformadas utilizando el logaritmo natural, la relación entre la variable de respuesta y las covariables se establece en términos relativos. Es decir
