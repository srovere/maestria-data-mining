...
# Seleccionamos el año 2018 a efectos ilustrativos. La idea se basa en que hay estaciones más cortas
...
series.descompuestas <- purrr::map_dfr(
  ...
  .f = function(omm_id) {
    DesestacionalizarSerieTemporal(dplyr::filter(series.estudio, omm_id == !! omm_id))
  }
)
